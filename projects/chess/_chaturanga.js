gamerules.chaturanga = {
	name: "Chaturanga / Shatranj",
	description: "The ancient Indian/Iranian predecessor of chess. Mantri (queens) can only move diagonal one square. Gaja/elephants (bishops) hop 2 squares diagonally. And you can't even castle",
	establish() {
		board = [
